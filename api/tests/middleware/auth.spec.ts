...
describe("authMiddleware", () => {
    ...
    it("retourne UnauthorizedError quand aucun token n'est fourni", async () => {
    ...
    it("retourne UnauthorizedError quand le token est invalide", async () => {
        mockReq.headers = {
    ...
    it("retourne UnauthorizedError quand l'utilisateur n'existe pas", async () => {
        mockReq.headers = {
            authorization: "Bearer valid_token",
        };
    ...
    it("retourne UnauthorizedError quand une erreur se produit", async () => {
        mockReq.headers = {
            authorization: "Bearer valid_token",
        };
